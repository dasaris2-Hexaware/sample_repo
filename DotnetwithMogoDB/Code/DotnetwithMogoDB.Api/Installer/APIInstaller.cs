...
using ElmahCore.Mvc;
using ElmahCore;
using DotnetwithMogoDB.Api.Filters;
using DotnetwithMogoDB.Business.Installer;

namespace DotnetwithMogoDB.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DotnetwithMogoDB API", Version = version + "-" + branch});
            });
